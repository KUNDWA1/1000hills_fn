  ...
  return (
    <main className={styles.wrapper}>
      <div className={styles.card}>
        ...
        <p className={styles.sub}>Hello <strong>{user?.name || 'there'}</strong>, you've successfully signed in to 1000 Hills Engineering.</p>
        <p className={styles.desc}>Explore our full range of professional equipment — from construction tools and power generators to solar energy solutions and security systems.</p>
